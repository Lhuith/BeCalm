...
{
    /// <summary>
    ///     This is a sample plugin that provides mouse/touch control for lifting fluids.
    /// </summary>
    ...
    public class FluidTouch : FluidParticlePlugin
    {
        ...
        protected override void OnSetComputeShaderVariables()
        {
            ...
            SetComputePluginValue(1, radius);
            SetComputePluginValue(2, m_TouchPointsCount);
            SetComputePluginBuffer(3, m_TouchPoints);
        }        
